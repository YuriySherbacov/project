...
const NumberOfFilms = +prompt('Сколько фильмов вы уже посмотрели?', ''); // через промт мы задаем вопрос пользователю

const personalMovieDB = { // DB расшифровуется как дата бейс, база данных
    'count': NumberOfFilms, // count - это свойство, и сюда передается ответ на 1 вопрос, который был выше
    'movies': {},
    'actors': {},
    'genres': [],
    'privat': false
